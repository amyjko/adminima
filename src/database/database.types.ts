...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      add_comment: {
        Args: { _id: string; _orgid: string; _table: string; _what: string }
        Returns: string
      }
      create_org: {
        Args: {
      ...
      getprofileid: { Args: { _orgid: string }; Returns: string }
      getvisibility: {
        Args: { _orgid: string }
        Returns: Database["public"]["Enums"]["visibility"]
      }
      isadmin: { Args: { _orgid: string }; Returns: boolean }
      iseditablehow: {
        Args: { _orgid: string; _processid: string }
        Returns: boolean
      }
      ismember: { Args: { _orgid: string }; Returns: boolean }
      path_available: { Args: { _path: string }; Returns: boolean }
    }
    Enums: {
